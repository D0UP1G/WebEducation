...
class StepSummarySerializer(serializers.ModelSerializer):
    class Meta:
        model = StepRevision
        fields = ("id", "title", "type_key", "position")
...
class QuestionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StepQuestion
        fields = ("id", "enrollment_id", "student", "step", "question", "answer", "created_at", "answered_at")
...
class CuratorSubmissionSerializer(CuratorAttemptSerializer):
    ...
    class Meta(SubmissionSerializer.Meta):
        fields = SubmissionSerializer.Meta.fields + ("student", "step", "attempts")
