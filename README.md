...
вход и кабинеты трёх ролей, редактор курса, семь типов шагов, сдачи,
...
Строгая текущая приёмка и оставшиеся блокеры — в [MVP-аудите](docs/mvp-audit-2026-09-24.md).
