...
ученическое чтение работают с backend; сдачи, браузерная проверка Python,
очередь куратора и вопросы описаны в [DEV-3 handoff](docs/dev3-handoff.md).
...
- DEV-3 владеет `grading`, `mentoring`, `progress` и браузерным протоколом Python.
