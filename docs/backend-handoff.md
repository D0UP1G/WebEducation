...
DEV-2 и DEV-3. Это handoff исходного backend-каркаса. Текущая реализация
сдач и решение о браузерном Python описаны в [DEV-3 handoff](dev3-handoff.md).
Источник истины по API — `api-contract.md` и код.
