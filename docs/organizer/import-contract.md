...
После интеграции схемы и правил DEV-3 DEV-4 сможет реализовать транзакционный идемпотентный импорт в draft, затем опубликовать версии и проверить 3 курса / 9 модулей / 30 шагов и ролевую выдачу.
