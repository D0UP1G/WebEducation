...
**Актуальный контракт (`develop` после PR #51):** локальная самопроверка
...
структуру модулей к ответам каталога; feature `official-curriculum-demo`
показывает этот паспорт и модули ученику. Остальные контракты v1, включая
