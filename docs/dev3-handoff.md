...
После объединения PR #11–#13 проходят 22 backend-теста, 25 frontend-тестов,
сборка Vite и проверка отсутствия новых миграций. DEV-3 не изменял frontend
в этих исправлениях. В локальном
