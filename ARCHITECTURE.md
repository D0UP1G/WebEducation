...
| `Course` | Название, описание, диапазон классов, владелец, `source_id` и паспорт курса (`tool`, `goal`, `volume`) |
| `Module` | Группировка черновых шагов внутри курса с позицией и стабильным `source_id` |
| `CourseRevision` | Неизменяемый опубликованный выпуск курса вместе с копией паспорта и ключом источника |
