...
Статус: архитектурная основа реализованного MVP. После получения официальных материалов и решения о защищённом зачёте появились изменения, которых текущий код ещё не содержит. Их контракт и владельцы — в [текущем плане](docs/team-work-plan.md), доказанные разрывы — в [сверке](docs/current-gap-analysis.md). Описания браузерной проверки ниже отражают действующий код до внедрения официального серверного исполнения.
...
- Восстановить ли при публикации обязательность контрольного вопроса вместе с теорией: §04 кейса требует оба шага, а прежнее решение владельца и действующий код требуют только теорию. Все полученные курсы содержат вопросы.
...
неизменяемой версии курса уже выбраны; это не открытые вопросы.
