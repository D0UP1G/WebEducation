...
Каждый участник работает в отдельной ветке или worktree, а не одновременно в одном рабочем каталоге. Автор pull request проверяет изменения и запускает приложение перед слиянием. Основная ветка должна в любой момент оставаться запускаемой.
